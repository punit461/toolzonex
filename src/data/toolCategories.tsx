...
export const categories: ToolCategory[] = [
  {
    ...
    tools: [
      ...
      { title: 'Compound Interest Calculator', description: 'See the power of compounding on a lump sum.', path: '/finance/compound-interest-calculator', icon: <TrendingUpIcon fontSize="large" color="primary" /> },
      ...
      { title: 'Gold Rate Calculator', description: 'Gold price by weight, currency & region tax (GST/VAT/sales tax).', path: '/finance/gold-calculator', icon: <DiamondIcon fontSize="large" color="primary" /> },
      { title: 'Silver Rate Calculator', description: 'Silver price by weight, currency & region tax (GST/VAT/sales tax).', path: '/finance/silver-calculator', icon: <ChangeHistoryIcon fontSize="large" color="primary" /> },
      ...
      { title: 'US Mortgage Calculator', description: 'Monthly payment (PITI) with tax, insurance & PMI.', path: '/finance/mortgage-calculator', icon: <HomeWorkIcon fontSize="large" color="primary" /> },
      { title: 'IRA & Roth IRA Calculator', description: '2026 contribution limits, Roth eligibility & deduction phase-out.', path: '/finance/ira-roth-calculator', icon: <SavingsIcon fontSize="large" color="primary" /> },
      { title: 'UK Stamp Duty Calculator', description: 'SDLT for England & NI, incl. first-time buyer relief.', path: '/finance/uk-stamp-duty-calculator', icon: <HomeWorkIcon fontSize="large" color="primary" /> },
      { title: 'Self-Employment Tax Calculator', description: 'Social Security, Medicare & income tax for 1099 income.', path: '/finance/self-employment-tax-calculator', icon: <ReceiptIcon fontSize="large" color="primary" /> },
      { title: 'Capital Gains Tax Calculator', description: 'Federal, NIIT & state tax on short/long-term gains.', path: '/finance/capital-gains-tax-calculator', icon: <TrendingUpIcon fontSize="large" color="primary" /> },
  ...
  },
  {
    ...
    tools: [
      ...
      { title: 'Alabama Paycheck Calculator', description: 'Take-home pay after federal tax & FICA in Alabama.', path: '/finance/alabama-paycheck-calculator', icon: <CalculateIcon fontSize="large" color="primary" /> },
      { title: 'Alaska Paycheck Calculator', description: 'Take-home pay after federal tax & FICA in Alaska.', path: '/finance/alaska-paycheck-calculator', icon: <CalculateIcon fontSize="large" color="primary" /> },
      { title: 'Arizona Paycheck Calculator', description: 'Take-home pay after federal tax & FICA in Arizona.', path: '/finance/arizona-paycheck-calculator', icon: <CalculateIcon fontSize="large" color="primary" /> },
      { title: 'Arkansas Paycheck Calculator', description: 'Take-home pay after federal tax & FICA in Arkansas.', path: '/finance/arkansas-paycheck-calculator', icon: <CalculateIcon fontSize="large" color="primary" /> },
      { title: 'California Paycheck Calculator', description: 'Take-home pay after federal tax & FICA in California.', path: '/finance/california-paycheck-calculator', icon: <CalculateIcon fontSize="large" color="primary" /> },
      { title: 'Colorado Paycheck Calculator', description: 'Take-home pay after federal tax & FICA in Colorado.', path: '/finance/colorado-paycheck-calculator', icon: <CalculateIcon fontSize="large" color="primary" /> },
      { title: 'Connecticut Paycheck Calculator', description: 'Take-home pay after federal tax & FICA in Connecticut.', path: '/finance/connecticut-paycheck-calculator', icon: <CalculateIcon fontSize="large" color="primary" /> },
      { title: 'Delaware Paycheck Calculator', description: 'Take-home pay after federal tax & FICA in Delaware.', path: '/finance/delaware-paycheck-calculator', icon: <CalculateIcon fontSize="large" color="primary" /> },
      { title: 'Florida Paycheck Calculator', description: 'Take-home pay after federal tax & FICA in Florida.', path: '/finance/florida-paycheck-calculator', icon: <CalculateIcon fontSize="large" color="primary" /> },
      { title: 'Georgia Paycheck Calculator', description: 'Take-home pay after federal tax & FICA in Georgia.', path: '/finance/georgia-paycheck-calculator', icon: <CalculateIcon fontSize="large" color="primary" /> },
      { title: 'Hawaii Paycheck Calculator', description: 'Take-home pay after federal tax & FICA in Hawaii.', path: '/finance/hawaii-paycheck-calculator', icon: <CalculateIcon fontSize="large" color="primary" /> },
      { title: 'Idaho Paycheck Calculator', description: 'Take-home pay after federal tax & FICA in Idaho.', path: '/finance/idaho-paycheck-calculator', icon: <CalculateIcon fontSize="large" color="primary" /> },
      { title: 'Illinois Paycheck Calculator', description: 'Take-home pay after federal tax & FICA in Illinois.', path: '/finance/illinois-paycheck-calculator', icon: <CalculateIcon fontSize="large" color="primary" /> },
      { title: 'Indiana Paycheck Calculator', description: 'Take-home pay after federal tax & FICA in Indiana.', path: '/finance/indiana-paycheck-calculator', icon: <CalculateIcon fontSize="large" color="primary" /> },
      { title: 'Iowa Paycheck Calculator', description: 'Take-home pay after federal tax & FICA in Iowa.', path: '/finance/iowa-paycheck-calculator', icon: <CalculateIcon fontSize="large" color="primary" /> },
      { title: 'Kansas Paycheck Calculator', description: 'Take-home pay after federal tax & FICA in Kansas.', path: '/finance/kansas-paycheck-calculator', icon: <CalculateIcon fontSize="large" color="primary" /> },
      { title: 'Kentucky Paycheck Calculator', description: 'Take-home pay after federal tax & FICA in Kentucky.', path: '/finance/kentucky-paycheck-calculator', icon: <CalculateIcon fontSize="large" color="primary" /> },
      { title: 'Louisiana Paycheck Calculator', description: 'Take-home pay after federal tax & FICA in Louisiana.', path: '/finance/louisiana-paycheck-calculator', icon: <CalculateIcon fontSize="large" color="primary" /> },
      { title: 'Maine Paycheck Calculator', description: 'Take-home pay after federal tax & FICA in Maine.', path: '/finance/maine-paycheck-calculator', icon: <CalculateIcon fontSize="large" color="primary" /> },
      { title: 'Maryland Paycheck Calculator', description: 'Take-home pay after federal tax & FICA in Maryland.', path: '/finance/maryland-paycheck-calculator', icon: <CalculateIcon fontSize="large" color="primary" /> },
      { title: 'Massachusetts Paycheck Calculator', description: 'Take-home pay after federal tax & FICA in Massachusetts.', path: '/finance/massachusetts-paycheck-calculator', icon: <CalculateIcon fontSize="large" color="primary" /> },
      { title: 'Michigan Paycheck Calculator', description: 'Take-home pay after federal tax & FICA in Michigan.', path: '/finance/michigan-paycheck-calculator', icon: <CalculateIcon fontSize="large" color="primary" /> },
      { title: 'Minnesota Paycheck Calculator', description: 'Take-home pay after federal tax & FICA in Minnesota.', path: '/finance/minnesota-paycheck-calculator', icon: <CalculateIcon fontSize="large" color="primary" /> },
      { title: 'Mississippi Paycheck Calculator', description: 'Take-home pay after federal tax & FICA in Mississippi.', path: '/finance/mississippi-paycheck-calculator', icon: <CalculateIcon fontSize="large" color="primary" /> },
      { title: 'Missouri Paycheck Calculator', description: 'Take-home pay after federal tax & FICA in Missouri.', path: '/finance/missouri-paycheck-calculator', icon: <CalculateIcon fontSize="large" color="primary" /> },
      { title: 'Montana Paycheck Calculator', description: 'Take-home pay after federal tax & FICA in Montana.', path: '/finance/montana-paycheck-calculator', icon: <CalculateIcon fontSize="large" color="primary" /> },
      { title: 'Nebraska Paycheck Calculator', description: 'Take-home pay after federal tax & FICA in Nebraska.', path: '/finance/nebraska-paycheck-calculator', icon: <CalculateIcon fontSize="large" color="primary" /> },
      { title: 'Nevada Paycheck Calculator', description: 'Take-home pay after federal tax & FICA in Nevada.', path: '/finance/nevada-paycheck-calculator', icon: <CalculateIcon fontSize="large" color="primary" /> },
      { title: 'New Hampshire Paycheck Calculator', description: 'Take-home pay after federal tax & FICA in New Hampshire.', path: '/finance/new-hampshire-paycheck-calculator', icon: <CalculateIcon fontSize="large" color="primary" /> },
      { title: 'New Jersey Paycheck Calculator', description: 'Take-home pay after federal tax & FICA in New Jersey.', path: '/finance/new-jersey-paycheck-calculator', icon: <CalculateIcon fontSize="large" color="primary" /> },
      { title: 'New Mexico Paycheck Calculator', description: 'Take-home pay after federal tax & FICA in New Mexico.', path: '/finance/new-mexico-paycheck-calculator', icon: <CalculateIcon fontSize="large" color="primary" /> },
      { title: 'New York Paycheck Calculator', description: 'Take-home pay after federal tax & FICA in New York.', path: '/finance/new-york-paycheck-calculator', icon: <CalculateIcon fontSize="large" color="primary" /> },
      { title: 'North Carolina Paycheck Calculator', description: 'Take-home pay after federal tax & FICA in North Carolina.', path: '/finance/north-carolina-paycheck-calculator', icon: <CalculateIcon fontSize="large" color="primary" /> },
      { title: 'North Dakota Paycheck Calculator', description: 'Take-home pay after federal tax & FICA in North Dakota.', path: '/finance/north-dakota-paycheck-calculator', icon: <CalculateIcon fontSize="large" color="primary" /> },
      { title: 'Ohio Paycheck Calculator', description: 'Take-home pay after federal tax & FICA in Ohio.', path: '/finance/ohio-paycheck-calculator', icon: <CalculateIcon fontSize="large" color="primary" /> },
      { title: 'Oklahoma Paycheck Calculator', description: 'Take-home pay after federal tax & FICA in Oklahoma.', path: '/finance/oklahoma-paycheck-calculator', icon: <CalculateIcon fontSize="large" color="primary" /> },
      { title: 'Oregon Paycheck Calculator', description: 'Take-home pay after federal tax & FICA in Oregon.', path: '/finance/oregon-paycheck-calculator', icon: <CalculateIcon fontSize="large" color="primary" /> },
      { title: 'Pennsylvania Paycheck Calculator', description: 'Take-home pay after federal tax & FICA in Pennsylvania.', path: '/finance/pennsylvania-paycheck-calculator', icon: <CalculateIcon fontSize="large" color="primary" /> },
      { title: 'Rhode Island Paycheck Calculator', description: 'Take-home pay after federal tax & FICA in Rhode Island.', path: '/finance/rhode-island-paycheck-calculator', icon: <CalculateIcon fontSize="large" color="primary" /> },
      { title: 'South Carolina Paycheck Calculator', description: 'Take-home pay after federal tax & FICA in South Carolina.', path: '/finance/south-carolina-paycheck-calculator', icon: <CalculateIcon fontSize="large" color="primary" /> },
      { title: 'South Dakota Paycheck Calculator', description: 'Take-home pay after federal tax & FICA in South Dakota.', path: '/finance/south-dakota-paycheck-calculator', icon: <CalculateIcon fontSize="large" color="primary" /> },
      { title: 'Tennessee Paycheck Calculator', description: 'Take-home pay after federal tax & FICA in Tennessee.', path: '/finance/tennessee-paycheck-calculator', icon: <CalculateIcon fontSize="large" color="primary" /> },
      { title: 'Texas Paycheck Calculator', description: 'Take-home pay after federal tax & FICA in Texas.', path: '/finance/texas-paycheck-calculator', icon: <CalculateIcon fontSize="large" color="primary" /> },
      { title: 'Utah Paycheck Calculator', description: 'Take-home pay after federal tax & FICA in Utah.', path: '/finance/utah-paycheck-calculator', icon: <CalculateIcon fontSize="large" color="primary" /> },
      { title: 'Vermont Paycheck Calculator', description: 'Take-home pay after federal tax & FICA in Vermont.', path: '/finance/vermont-paycheck-calculator', icon: <CalculateIcon fontSize="large" color="primary" /> },
      { title: 'Virginia Paycheck Calculator', description: 'Take-home pay after federal tax & FICA in Virginia.', path: '/finance/virginia-paycheck-calculator', icon: <CalculateIcon fontSize="large" color="primary" /> },
      { title: 'Washington Paycheck Calculator', description: 'Take-home pay after federal tax & FICA in Washington.', path: '/finance/washington-paycheck-calculator', icon: <CalculateIcon fontSize="large" color="primary" /> },
      { title: 'West Virginia Paycheck Calculator', description: 'Take-home pay after federal tax & FICA in West Virginia.', path: '/finance/west-virginia-paycheck-calculator', icon: <CalculateIcon fontSize="large" color="primary" /> },
      { title: 'Wisconsin Paycheck Calculator', description: 'Take-home pay after federal tax & FICA in Wisconsin.', path: '/finance/wisconsin-paycheck-calculator', icon: <CalculateIcon fontSize="large" color="primary" /> },
      { title: 'Wyoming Paycheck Calculator', description: 'Take-home pay after federal tax & FICA in Wyoming.', path: '/finance/wyoming-paycheck-calculator', icon: <CalculateIcon fontSize="large" color="primary" /> },
    ],
  },
  {
    label: 'Health',
  ...
  },
  {
    ...
    tools: [
      ...
      { title: 'Black Screen', description: 'Plain fullscreen black.', path: '/utilities/black-screen', icon: <FullscreenIcon fontSize="large" color="primary" /> },
      { title: 'Blue Screen', description: 'Plain fullscreen blue.', path: '/utilities/blue-screen', icon: <FullscreenIcon fontSize="large" color="primary" /> },
      { title: 'Green Screen', description: 'Chroma-key green for video calls.', path: '/utilities/green-screen', icon: <FullscreenIcon fontSize="large" color="primary" /> },
      { title: 'Red Screen', description: 'Plain fullscreen red.', path: '/utilities/red-screen', icon: <FullscreenIcon fontSize="large" color="primary" /> },
      { title: 'Orange Screen', description: 'Plain fullscreen orange.', path: '/utilities/orange-screen', icon: <FullscreenIcon fontSize="large" color="primary" /> },
      { title: 'Pink Screen', description: 'Plain fullscreen pink.', path: '/utilities/pink-screen', icon: <FullscreenIcon fontSize="large" color="primary" /> },
      { title: 'Purple Screen', description: 'Plain fullscreen purple.', path: '/utilities/purple-screen', icon: <FullscreenIcon fontSize="large" color="primary" /> },
      { title: 'Yellow Screen', description: 'Plain fullscreen yellow.', path: '/utilities/yellow-screen', icon: <FullscreenIcon fontSize="large" color="primary" /> },
      { title: 'Zoom Lighting Screen', description: 'Warm fullscreen light for video calls.', path: '/utilities/zoom-lighting-screen', icon: <FullscreenIcon fontSize="large" color="primary" /> },
      { title: 'Dead Pixel Test', description: 'Find stuck or dead pixels on your monitor.', path: '/utilities/dead-pixel-test', icon: <FullscreenIcon fontSize="large" color="primary" /> },
      { title: 'DVD Screensaver', description: 'The classic bouncing DVD logo.', path: '/utilities/dvd-screensaver', icon: <FullscreenIcon fontSize="large" color="primary" /> },
      { title: 'Broken Screen', description: 'Fake cracked-screen prank.', path: '/utilities/broken-screen', icon: <FullscreenIcon fontSize="large" color="primary" /> },
      { title: 'Windows 10 Blue Screen', description: 'Fake BSOD prank.', path: '/utilities/windows-10-blue-screen', icon: <FullscreenIcon fontSize="large" color="primary" /> },
      { title: 'Windows 10 Update Screen', description: 'Fake Windows update prank.', path: '/utilities/windows-10-update-screen', icon: <FullscreenIcon fontSize="large" color="primary" /> },
      { title: 'Windows 11 Blue Screen', description: 'Fake error screen prank.', path: '/utilities/windows-11-blue-screen', icon: <FullscreenIcon fontSize="large" color="primary" /> },
      { title: 'Windows 11 Update Screen', description: 'Fake Windows update prank.', path: '/utilities/windows-11-update-screen', icon: <FullscreenIcon fontSize="large" color="primary" /> },
    ],
  },
  {
    label: 'Tools',
  ...
  },
  {
    ...
    tools: [
      ...
      { title: 'Rotate PDF', description: 'Rotate all pages by 90/180/270°.', path: '/tools/rotate-pdf', icon: <PictureAsPdfIcon fontSize="large" color="primary" /> },
      { title: 'Delete PDF Pages', description: 'Remove specific pages from a PDF.', path: '/tools/delete-pdf-pages', icon: <PictureAsPdfIcon fontSize="large" color="primary" /> },
      { title: 'Extract PDF Pages', description: 'Pull specific pages into a new PDF.', path: '/tools/extract-pdf-pages', icon: <PictureAsPdfIcon fontSize="large" color="primary" /> },
      { title: 'Organize PDF', description: 'Reorder pages in a PDF.', path: '/tools/organize-pdf', icon: <PictureAsPdfIcon fontSize="large" color="primary" /> },
      { title: 'Add Page Numbers to PDF', description: 'Number every page of a PDF.', path: '/tools/number-pdf-pages', icon: <PictureAsPdfIcon fontSize="large" color="primary" /> },
      { title: 'Watermark PDF', description: 'Add a diagonal text watermark to a PDF.', path: '/tools/watermark-pdf', icon: <PictureAsPdfIcon fontSize="large" color="primary" /> },
      { title: 'Flatten PDF', description: 'Make PDF form fields permanent.', path: '/tools/flatten-pdf', icon: <PictureAsPdfIcon fontSize="large" color="primary" /> },
      { title: 'JPG to PDF', description: 'Convert images into a PDF.', path: '/tools/jpg-to-pdf', icon: <PictureAsPdfIcon fontSize="large" color="primary" /> },
      { title: 'Text to PDF', description: 'Convert plain text into a PDF.', path: '/tools/text-to-pdf', icon: <PictureAsPdfIcon fontSize="large" color="primary" /> },
      { title: 'CSV to PDF', description: 'Convert a CSV into a PDF table.', path: '/tools/csv-to-pdf', icon: <PictureAsPdfIcon fontSize="large" color="primary" /> },
      { title: 'Word to PDF', description: 'Convert a .docx file into a PDF.', path: '/tools/word-to-pdf', icon: <PictureAsPdfIcon fontSize="large" color="primary" /> },
      { title: 'Excel to PDF', description: 'Convert a spreadsheet into a PDF table.', path: '/tools/excel-to-pdf', icon: <PictureAsPdfIcon fontSize="large" color="primary" /> },
      { title: 'HTML to PDF', description: 'Convert HTML markup into a PDF.', path: '/tools/html-to-pdf', icon: <PictureAsPdfIcon fontSize="large" color="primary" /> },
    ],
  },
  {
    label: 'Text Tools',
