...
export const toolRegistry: ToolRegistryEntry[] = [
  ...
  // ═══════════════════════════════════════════════════════
  // FLAGSHIP TOOLS — Phase 1 Quick Wins (volume >= 10K)
  // ═══════════════════════════════════════════════════════
  {
    route: "/finance/emergency-fund-calculator",
    navName: "Emergency Fund Calculator",
    navDescription: "Calculate how much to save for emergencies.",
    name: "Emergency Fund Calculator",
    description: "Find out how many months of expenses you should save and how long it will take to build your emergency fund.",
    navCategory: "Finance",
    shellCategory: "Finance",
    icon: <AccountBalanceWalletIcon fontSize="large" color="primary" />,
    seoTitle: "Emergency Fund Calculator — How Much to Save for Emergencies",
    seoDescription: "Free emergency fund calculator to find out how much you need to save for 3-12 months of expenses and how long it will take to build your fund.",
    keywords: ["emergency fund calculator","emergency savings calculator","how much emergency fund","emergency fund india","rainy day fund calculator"],
    ogTitle: "Emergency Fund Calculator — How Much to Save for Emergencies | ToolZoneX",
    ogDescription: "Find out how many months of expenses you should save and how long it will take to build your emergency fund.",
    schemaName: "Emergency Fund Calculator",
    schemaDescription: "Calculate how much emergency savings you need based on monthly expenses and income.",
    applicationCategory: "FinanceApplication",
    currency: "INR",
    faqs: [{ question: "How many months of expenses should I save?", answer: "Most experts recommend 3 to 6 months of essential expenses. If you're self-employed or have variable income, aim for 6 to 12 months." }, { question: "Should I include EMI payments in my expenses?", answer: "Yes — include all fixed obligations like rent, EMIs, insurance premiums, and essential living costs." }, { question: "Where should I keep my emergency fund?", answer: "Keep it in a liquid, easily accessible account like a savings account or a liquid mutual fund. Avoid locking it in FDs or long-term investments." }],
    isHub: false,
  },
  {
    route: "/finance/personal-loan-calculator",
    navName: "Personal Loan Calculator",
    navDescription: "Calculate EMI for personal loans.",
    name: "Personal Loan EMI Calculator",
    description: "Calculate your monthly EMI for personal loans with detailed interest breakdown and amortization schedule.",
    navCategory: "Finance",
    shellCategory: "Finance",
    icon: <PaymentsIcon fontSize="large" color="primary" />,
    seoTitle: "Personal Loan EMI Calculator — Calculate Monthly EMI Online",
    seoDescription: "Free personal loan EMI calculator. Enter loan amount, interest rate, and tenure to calculate your monthly EMI with amortization schedule.",
    keywords: ["personal loan emi calculator","personal loan calculator","emi calculator","personal loan emi","loan calculator india"],
    ogTitle: "Personal Loan EMI Calculator — Calculate Monthly EMI Online | ToolZoneX",
    ogDescription: "Calculate your monthly EMI for personal loans with detailed interest breakdown and amortization schedule.",
    schemaName: "Personal Loan EMI Calculator",
    schemaDescription: "Calculate monthly EMI for personal loans with amortization schedule.",
    applicationCategory: "FinanceApplication",
    currency: "INR",
    faqs: [{ question: "What is the typical interest rate for personal loans in India?", answer: "Personal loan interest rates in India typically range from 10% to 24% per annum, depending on your credit score, income, and lender." }, { question: "How is personal loan EMI calculated?", answer: "EMI = P × r × (1+r)^n / [(1+r)^n – 1], where P = loan amount, r = monthly interest rate, n = tenure in months." }, { question: "Can I prepay my personal loan?", answer: "Most lenders allow prepayment, but some may charge a prepayment penalty of 2-5% of the outstanding amount." }],
    isHub: false,
  },
  {
    route: "/finance/tax-calculator",
    navName: "Tax Calculator",
    navDescription: "Calculate income tax under old and new regimes.",
    name: "Income Tax Calculator FY 2025-26",
    description: "Calculate your income tax liability under both old and new tax regimes for FY 2025-26 (AY 2026-27). Compare which regime saves you more tax.",
    navCategory: "Finance",
    shellCategory: "Finance",
    icon: <ReceiptIcon fontSize="large" color="primary" />,
    seoTitle: "Income Tax Calculator FY 2025-26 — Old vs New Regime Compare",
    seoDescription: "Free income tax calculator for FY 2025-26. Compare old vs new tax regime, calculate tax on salary, and find out which regime saves you more.",
    keywords: ["income tax calculator","tax calculator india","old vs new tax regime","income tax fy 2025-26","salary tax calculator"],
    ogTitle: "Income Tax Calculator FY 2025-26 — Old vs New Regime Compare | ToolZoneX",
    ogDescription: "Calculate your income tax liability under both old and new tax regimes for FY 2025-26.",
    schemaName: "Income Tax Calculator",
    schemaDescription: "Calculate income tax under old and new regimes for FY 2025-26.",
    applicationCategory: "FinanceApplication",
    currency: "INR",
    faqs: [{ question: "Which tax regime is better — old or new?", answer: "It depends on your deductions. If you have significant deductions (80C, 80D, HRA, home loan), the old regime may be better. Otherwise, the new regime with its lower rates is usually advantageous." }, { question: "What is the standard deduction under the new regime?", answer: "For FY 2025-26, the standard deduction under the new regime is ₹75,000 for salaried individuals." }, { question: "Is this calculator accurate for filing?", answer: "This calculator provides an estimate. For actual filing, consider consulting a tax professional or using the official Income Tax Department portal." }],
    isHub: false,
  },
  {
    route: "/finance/cagr-calculator",
    navName: "CAGR Calculator",
    navDescription: "Calculate compound annual growth rate.",
    name: "CAGR Calculator",
    description: "Calculate the Compound Annual Growth Rate (CAGR) of your investments. Find out the annualized return on mutual funds, stocks, or FDs.",
    navCategory: "Finance",
    shellCategory: "Finance",
    icon: <AutoGraphIcon fontSize="large" color="primary" />,
    seoTitle: "CAGR Calculator — Calculate Compound Annual Growth Rate Online",
    seoDescription: "Free CAGR calculator to find the compound annual growth rate of investments. Calculate annualized returns on mutual funds, stocks, and FDs.",
    keywords: ["cagr calculator","compound annual growth rate","cagr formula","investment return calculator","mutual fund cagr"],
    ogTitle: "CAGR Calculator — Calculate Compound Annual Growth Rate Online | ToolZoneX",
    ogDescription: "Calculate the Compound Annual Growth Rate (CAGR) of your investments.",
    schemaName: "CAGR Calculator",
    schemaDescription: "Calculate the compound annual growth rate of investments.",
    applicationCategory: "FinanceApplication",
    currency: "INR",
    faqs: [{ question: "What is CAGR?", answer: "CAGR (Compound Annual Growth Rate) is the annualized rate of return on an investment, calculated as (Ending Value / Beginning Value)^(1/years) - 1." }, { question: "How is CAGR different from absolute return?", answer: "Absolute return shows total growth, while CAGR shows the annualized growth rate, making it easier to compare investments of different durations." }, { question: "Can I use CAGR to compare mutual funds?", answer: "Yes — CAGR is the standard metric for comparing mutual fund performance over the same time period." }],
    isHub: false,
  },
  {
    route: "/finance/gold-loan-calculator",
    navName: "Gold Loan Calculator",
    navDescription: "Calculate gold loan EMI and interest.",
    name: "Gold Loan Calculator",
    description: "Calculate your gold loan EMI, total interest payable, and see the amortization schedule. Compare gold loan offers from different banks.",
    navCategory: "Finance",
    shellCategory: "Finance",
    icon: <DiamondIcon fontSize="large" color="primary" />,
    seoTitle: "Gold Loan Calculator — Calculate Gold Loan EMI Online Free",
    seoDescription: "Free gold loan calculator. Calculate monthly EMI, total interest, and amortization schedule for gold loans from banks and NBFCs.",
    keywords: ["gold loan calculator","gold loan emi","gold loan interest rate","gold loan emi calculator","gold loan india"],
    ogTitle: "Gold Loan Calculator — Calculate Gold Loan EMI Online Free | ToolZoneX",
    ogDescription: "Calculate your gold loan EMI, total interest payable, and see the amortization schedule.",
    schemaName: "Gold Loan Calculator",
    schemaDescription: "Calculate gold loan EMI and interest with amortization schedule.",
    applicationCategory: "FinanceApplication",
    currency: "INR",
    faqs: [{ question: "What is the typical interest rate for gold loans?", answer: "Gold loan interest rates in India range from 7% to 15% per annum, depending on the lender, loan amount, and tenure." }, { question: "How much can I borrow against gold?", answer: "Banks typically offer 75-90% of the gold's market value as loan amount, depending on the gold purity and lender policies." }, { question: "What happens if I can't repay my gold loan?", answer: "If you default, the lender can auction your gold collateral to recover the outstanding amount after giving you adequate notice." }],
    isHub: false,
  },
  {
    route: "/text-tools/case-converter",
    navName: "Case Converter",
    navDescription: "Convert text between uppercase, lowercase, title case, and more.",
    name: "Case Converter — Transform Text Case Online",
    description: "Convert text between uppercase, lowercase, title case, sentence case, and more. Perfect for formatting documents, code, and content.",
    navCategory: "Text Tools",
    shellCategory: "Text Tools",
    icon: <TextFormatIcon fontSize="large" color="primary" />,
    seoTitle: "Case Converter — Convert Text to Uppercase, Lowercase Online Free",
    seoDescription: "Free online case converter. Transform text between uppercase, lowercase, title case, sentence case, and more instantly.",
    keywords: ["case converter","text case converter","uppercase to lowercase","lowercase to uppercase","title case converter","sentence case"],
    ogTitle: "Case Converter — Convert Text to Uppercase, Lowercase Online Free | ToolZoneX",
    ogDescription: "Convert text between uppercase, lowercase, title case, sentence case, and more.",
    schemaName: "Case Converter",
    schemaDescription: "Convert text between different case formats: uppercase, lowercase, title case, sentence case.",
    applicationCategory: "DeveloperApplication",
    faqs: [{ question: "What is title case?", answer: "Title case capitalizes the first letter of each major word. For example, 'the quick brown fox' becomes 'The Quick Brown Fox'." }, { question: "What is sentence case?", answer: "Sentence case capitalizes only the first letter of the first word. For example, 'hello world. how are you?' becomes 'Hello world. How are you?'." }, { question: "Does this work with special characters?", answer: "Yes — the converter preserves all special characters, numbers, and formatting while only changing the letter casing." }],
    isHub: false,
  },
  {
    route: "/text-tools/character-counter",
    navName: "Character Counter",
    navDescription: "Count characters, words, and lines in text.",
    name: " Character Counter — Count Characters, Words & Lines",
    description: "Count characters, words, sentences, lines, and paragraphs in your text. Great for social media posts, essays, and content writing.",
    navCategory: "Text Tools",
    shellCategory: "Text Tools",
    icon: <NumbersIcon fontSize="large" color="primary" />,
    seoTitle: "Character Counter — Count Characters, Words & Lines Online Free",
    seoDescription: "Free online character counter. Count characters, words, sentences, lines, and paragraphs. Perfect for Twitter, essays, and content limits.",
    keywords: ["character counter","word counter","text counter","character count online","word count tool"],
    ogTitle: "Character Counter — Count Characters, Words & Lines Online Free | ToolZoneX",
    ogDescription: "Count characters, words, sentences, lines, and paragraphs in your text.",
    schemaName: "Character Counter",
    schemaDescription: "Count characters, words, sentences, lines, and paragraphs in text.",
    applicationCategory: "UtilityApplication",
    faqs: [{ question: "Does this count spaces?", answer: "Yes, the character count includes spaces by default. You can also see the count without spaces separately." }, { question: "What's the character limit for Twitter/X?", answer: "Twitter/X allows 280 characters per tweet (or 25,000 characters for X Premium subscribers)." }, { question: "Does this work offline?", answer: "Yes — all counting happens in your browser. No data is sent to any server." }],
    isHub: false,
  },
  {
    route: "/developer-tools/json-viewer",
    navName: "JSON Viewer",
    navDescription: "View, format, and validate JSON data.",
    name: "JSON Viewer — Format, Validate & Beautify JSON",
    description: "Paste or type JSON data to instantly format, validate, and beautify it. View JSON in a collapsible tree structure or formatted text.",
    navCategory: "Developer Tools",
    shellCategory: "Developer Tools",
    icon: <CodeIcon fontSize="large" color="primary" />,
    seoTitle: "JSON Viewer — Format, Validate & Beautify JSON Online Free",
    seoDescription: "Free online JSON viewer and formatter. Paste JSON to format, validate, beautify, and view in a collapsible tree structure.",
    keywords: ["json viewer","json formatter","json validator","beautify json","format json","json editor online"],
    ogTitle: "JSON Viewer — Format, Validate & Beautify JSON Online Free | ToolZoneX",
    ogDescription: "Paste or type JSON data to instantly format, validate, and beautify it.",
    schemaName: "JSON Viewer",
    schemaDescription: "Format, validate, and view JSON data in a collapsible tree or formatted text.",
    applicationCategory: "DeveloperApplication",
    faqs: [{ question: "What is JSON?", answer: "JSON (JavaScript Object Notation) is a lightweight data interchange format commonly used in APIs and configuration files." }, { question: "Does this validate my JSON?", answer: "Yes — it shows syntax errors with line numbers if your JSON is invalid." }, { question: "Is my JSON data sent to a server?", answer: "No — all formatting and validation happens entirely in your browser." }],
    isHub: false,
  },
  {
    route: "/developer-tools/base64-encoder",
    navName: "Base64 Encoder",
    navDescription: "Encode text to Base64.",
    name: "Base64 Encoder — Encode Text to Base64 Online",
    description: "Encode any text string to Base64 format. Useful for encoding data for email, URLs, and API authentication.",
    navCategory: "Developer Tools",
    shellCategory: "Developer Tools",
    icon: <CodeIcon fontSize="large" color="primary" />,
    seoTitle: "Base64 Encoder — Encode Text to Base64 Online Free",
    seoDescription: "Free online Base64 encoder. Convert any text to Base64 format for email, URLs, and API authentication.",
    keywords: ["base64 encoder","encode to base64","base64 encode","text to base64","base64 encoding online"],
    ogTitle: "Base64 Encoder — Encode Text to Base64 Online Free | ToolZoneX",
    ogDescription: "Encode any text string to Base64 format.",
    schemaName: "Base64 Encoder",
    schemaDescription: "Encode text to Base64 format.",
    applicationCategory: "DeveloperApplication",
    faqs: [{ question: "What is Base64?", answer: "Base64 is an encoding scheme that represents binary data as ASCII text, commonly used for transmitting data over media that handle text." }, { question: "Is Base64 the same as encryption?", answer: "No — Base64 is encoding, not encryption. It's easily reversible and provides no security. Use proper encryption for sensitive data." }, { question: "Does this work with special characters?", answer: "Yes — the encoder handles all UTF-8 characters including emojis, accented characters, and symbols." }],
    isHub: false,
  },
  {
    route: "/developer-tools/base64-decoder",
    navName: "Base64 Decoder",
    navDescription: "Decode Base64 to text.",
    name: "Base64 Decoder — Decode Base64 to Text Online",
    description: "Decode any Base64 encoded string back to its original text. Fast, private, and runs entirely in your browser.",
    navCategory: "Developer Tools",
    shellCategory: "Developer Tools",
    icon: <CodeIcon fontSize="large" color="primary" />,
    seoTitle: "Base64 Decoder — Decode Base64 to Text Online Free",
    seoDescription: "Free online Base64 decoder. Convert Base64 encoded strings back to plain text instantly.",
    keywords: ["base64 decoder","decode base64","base64 decode","base64 to text","decode base64 online"],
    ogTitle: "Base64 Decoder — Decode Base64 to Text Online Free | ToolZoneX",
    ogDescription: "Decode any Base64 encoded string back to its original text.",
    schemaName: "Base64 Decoder",
    schemaDescription: "Decode Base64 encoded strings to plain text.",
    applicationCategory: "DeveloperApplication",
    faqs: [{ question: "What if my Base64 string is invalid?", answer: "The decoder will show an error message if the input is not valid Base64. Make sure you're pasting a properly encoded string." }, { question: "Does this handle URL-safe Base64?", answer: "Yes — the decoder handles both standard and URL-safe Base64 variants." }, { question: "Is my data sent anywhere?", answer: "No — decoding happens entirely in your browser. No data leaves your device." }],
    isHub: false,
  },
  {
    route: "/developer-tools/json-validator",
    navName: "JSON Validator",
    navDescription: "Validate JSON syntax and find errors.",
    name: "JSON Validator — Validate & Debug JSON Online",
    description: "Paste your JSON to instantly validate its syntax, find errors with line numbers, and fix common mistakes.",
    navCategory: "Developer Tools",
    shellCategory: "Developer Tools",
    icon: <CheckCircleIcon fontSize="large" color="primary" />,
    seoTitle: "JSON Validator — Validate & Debug JSON Syntax Online Free",
    seoDescription: "Free online JSON validator. Paste JSON to validate syntax, find errors with line numbers, and debug issues.",
    keywords: ["json validator","validate json","json syntax checker","json error finder","check json online"],
    ogTitle: "JSON Validator — Validate & Debug JSON Syntax Online Free | ToolZoneX",
    ogDescription: "Paste your JSON to instantly validate its syntax, find errors with line numbers.",
    schemaName: "JSON Validator",
    schemaDescription: "Validate JSON syntax and find errors with line numbers.",
    applicationCategory: "DeveloperApplication",
    faqs: [{ question: "What kind of errors does this catch?", answer: "It catches syntax errors like missing commas, unclosed brackets, trailing commas, unquoted keys, and incorrect string escaping." }, { question: "Can it fix JSON errors automatically?", answer: "Currently it only identifies errors with line numbers. Auto-fix is planned for a future update." }, { question: "Is there a size limit?", answer: "There's no hard limit, but very large JSON files (10MB+) may slow down the browser. For best performance, keep it under 5MB." }],
    isHub: false,
  },
  {
    route: "/developer-tools/xml-formatter",
    navName: "XML Formatter",
    navDescription: "Format and beautify XML data.",
    name: "XML Formatter — Beautify & Format XML Online",
    description: "Paste XML data to instantly format, beautify, and validate it with proper indentation and syntax highlighting.",
    navCategory: "Developer Tools",
    shellCategory: "Developer Tools",
    icon: <CodeIcon fontSize="large" color="primary" />,
    seoTitle: "XML Formatter — Beautify & Format XML Online Free",
    seoDescription: "Free online XML formatter. Paste XML to format, beautify, and validate with proper indentation.",
    keywords: ["xml formatter","format xml","xml beautifier","beautify xml","xml validator online"],
    ogTitle: "XML Formatter — Beautify & Format XML Online Free | ToolZoneX",
    ogDescription: "Paste XML data to instantly format, beautify, and validate it.",
    schemaName: "XML Formatter",
    schemaDescription: "Format and beautify XML data with proper indentation.",
    applicationCategory: "DeveloperApplication",
    faqs: [{ question: "Does this validate XML?", answer: "Yes — it checks for basic XML syntax errors and shows line numbers for any issues found." }, { question: "Can it minify XML?", answer: "Yes — the tool provides both formatted (beautified) and minified output options." }, { question: "Does it preserve XML comments?", answer: "Yes — all XML comments are preserved during formatting." }],
    isHub: false,
  },
  {
    route: "/developer-tools/url-decoder",
    navName: "URL Decoder",
    navDescription: "Decode URL-encoded strings.",
    name: "URL Decoder — Decode URL-Encoded Strings Online",
    description: "Decode any URL-encoded (percent-encoded) string back to its readable form. Fast, private, runs in your browser.",
    navCategory: "Developer Tools",
    shellCategory: "Developer Tools",
    icon: <LinkIcon fontSize="large" color="primary" />,
    seoTitle: "URL Decoder — Decode URL-Encoded Strings Online Free",
    seoDescription: "Free online URL decoder. Convert percent-encoded URLs and query strings back to readable text.",
    keywords: ["url decoder","decode url","percent decode","url decode online","decode query string"],
    ogTitle: "URL Decoder — Decode URL-Encoded Strings Online Free | ToolZoneX",
    ogDescription: "Decode any URL-encoded (percent-encoded) string back to its readable form.",
    schemaName: "URL Decoder",
    schemaDescription: "Decode URL-encoded (percent-encoded) strings to readable text.",
    applicationCategory: "DeveloperApplication",
    faqs: [{ question: "What is URL encoding?", answer: "URL encoding (percent-encoding) replaces unsafe characters with % followed by two hex digits. For example, a space becomes %20." }, { question: "Does this decode + as space?", answer: "Yes — the decoder handles both %20 and + as space characters, as both are used to represent spaces in URLs." }, { question: "Can I decode full URLs?", answer: "Yes — you can paste an entire URL or just a query string, and it will decode all encoded parts." }],
    isHub: false,
  },
  {
    route: "/utilities/dice-roller",
    navName: "Dice Roller",
    navDescription: "Roll virtual dice with customizable sides.",
    name: "Dice Roller — Roll Virtual Dice Online",
    description: "Roll 1 to 10 dice with 4 to 100 sides each. Perfect for tabletop games, D&D, and random number generation.",
    navCategory: "Utilities",
    shellCategory: "Utilities",
    icon: <CasinoIcon fontSize="large" color="primary" />,
    seoTitle: "Dice Roller — Roll Virtual Dice Online Free",
    seoDescription: "Free online dice roller. Roll 1-10 dice with 4-100 sides. Perfect for D&D, tabletop games, and random number generation.",
    keywords: ["dice roller","roll dice online","virtual dice","d20 dice roller","random dice","dice roller dnd"],
    ogTitle: "Dice Roller — Roll Virtual Dice Online Free | ToolZoneX",
    ogDescription: "Roll 1 to 10 dice with 4 to 100 sides each.",
    schemaName: "Dice Roller",
    schemaDescription: "Roll virtual dice with customizable count and number of sides.",
    applicationCategory: "UtilityApplication",
    faqs: [{ question: "Can I roll multiple dice at once?", answer: "Yes — you can roll between 1 and 10 dice simultaneously." }, { question: "What dice types are supported?", answer: "You can set any number of sides from 4 to 100, including standard D4, D6, D8, D10, D12, D20, and D100." }, { question: "Is this truly random?", answer: "Yes — it uses the browser's crypto.getRandomValues() for cryptographically secure randomness." }],
    isHub: false,
  },
  {
    route: "/utilities/love-calculator",
    navName: "Love Calculator",
    navDescription: "Calculate love compatibility between names.",
    name: "Love Calculator — Love Compatibility Test",
    description: "Enter two names to calculate love compatibility percentage. A fun tool for couples and friends to test their bond.",
    navCategory: "Utilities",
    shellCategory: "Utilities",
    icon: <FavoriteIcon fontSize="large" color="primary" />,
    seoTitle: "Love Calculator — Calculate Love Compatibility Online Free",
    seoDescription: "Free online love calculator. Enter two names to get a love compatibility percentage. Fun tool for couples and friends.",
    keywords: ["love calculator","love compatibility","love test","name love calculator","love percentage calculator"],
    ogTitle: "Love Calculator — Calculate Love Compatibility Online Free | ToolZoneX",
    ogDescription: "Enter two names to calculate love compatibility percentage.",
    schemaName: "Love Calculator",
    schemaDescription: "Calculate love compatibility percentage between two names.",
    applicationCategory: "UtilityApplication",
    faqs: [{ question: "Is this a real compatibility test?", answer: "No — this is a fun entertainment tool. Real relationships depend on communication, trust, and effort, not name algorithms." }, { question: "How does the calculation work?", answer: "It uses a deterministic hash of both names combined to produce a consistent percentage for the same pair of names." }, { question: "Does the result change if I swap the names?", answer: "No — the calculation is order-independent, so 'A & B' gives the same result as 'B & A'." }],
    isHub: false,
  },
  {
    route: "/converters/currency-converter",
    navName: "Currency Converter",
    navDescription: "Convert between world currencies.",
    name: "Currency Converter — Convert Between 150+ Currencies",
    description: "Convert between 150+ world currencies with live exchange rates. Supports INR, USD, EUR, GBP, and more.",
    navCategory: "Converters",
    shellCategory: "Converters",
    icon: <CurrencyExchangeIcon fontSize="large" color="primary" />,
    seoTitle: "Currency Converter — Convert Between 150+ Currencies Online Free",
    seoDescription: "Free online currency converter. Convert between 150+ world currencies with live exchange rates. INR, USD, EUR, GBP and more.",
    keywords: ["currency converter","exchange rate","currency exchange","inr to usd","usd to inr","euro to inr","gbp to inr"],
    ogTitle: "Currency Converter — Convert Between 150+ Currencies Online Free | ToolZoneX",
    ogDescription: "Convert between 150+ world currencies with live exchange rates.",
    schemaName: "Currency Converter",
    schemaDescription: "Convert between world currencies with live exchange rates.",
    applicationCategory: "UtilityApplication",
    faqs: [{ question: "Where do exchange rates come from?", answer: "Exchange rates are fetched from a free public API (exchangerate.host) on page load. Rates are indicative and may differ from bank rates." }, { question: "Are these rates accurate for actual transfers?", answer: "No — these are mid-market indicative rates. Actual transfer rates from banks and forex services include margins and fees." }, { question: "Does this work offline?", answer: "The converter needs an internet connection to fetch the latest rates. Once loaded, you can convert amounts without additional requests." }],
    isHub: false,
  },
  {
    route: "/generators/fancy-text-generator",
    navName: "Fancy Text Generator",
    navDescription: "Generate fancy styled text for social media.",
    name: "Fancy Text Generator — Stylish Text for Social Media",
    description: "Convert plain text into fancy styled text with cool fonts, symbols, and decorations. Perfect for Instagram, WhatsApp, and social media bios.",
    navCategory: "Generators",
    shellCategory: "Generators",
    icon: <AutoAwesomeIcon fontSize="large" color="primary" />,
    seoTitle: "Fancy Text Generator — Stylish Text for Instagram & WhatsApp Free",
    seoDescription: "Free fancy text generator. Create stylish text with cool fonts and symbols for Instagram, WhatsApp, and social media bios.",
    keywords: ["fancy text generator","stylish text generator","cool fonts generator","instagram bio fonts","whatsapp stylish text"],
    ogTitle: "Fancy Text Generator — Stylish Text for Instagram & WhatsApp Free | ToolZoneX",
    ogDescription: "Convert plain text into fancy styled text with cool fonts, symbols, and decorations.",
    schemaName: "Fancy Text Generator",
    schemaDescription: "Generate styled text with different fonts and decorations.",
    applicationCategory: "UtilityApplication",
    faqs: [{ question: "Will the fancy text display correctly everywhere?", answer: "Most modern platforms support Unicode styled text, but some older systems or apps may show boxes or question marks." }, { question: "Can I use this for my Instagram bio?", answer: "Yes — just copy the styled text and paste it directly into your Instagram bio, username, or captions." }, { question: "Is there a character limit?", answer: "The generator itself has no limit, but the platform you paste into (Instagram, WhatsApp, etc.) may have its own character limits." }],
    isHub: false,
  },
  {
